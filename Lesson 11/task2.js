...
Promise.all(promiseArray)
    .then(a => {promiseAll = a; console.log(promiseAll)})
    .catch(a => {promiseAll = a; console.log(promiseAll)});

let promiseRace;
Promise.race(promiseArray)
    .then(a => {promiseRace = a; console.log(promiseRace)})
    .catch(a => {promiseRace = a; console.log(promiseRace)});